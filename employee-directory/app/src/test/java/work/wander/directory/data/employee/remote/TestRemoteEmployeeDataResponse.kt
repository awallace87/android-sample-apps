...
/**
 * Mocked successful JSON response for employee data.

 */
const val valid_employee_uuid = "0d8fcc12-4d0c-425c-8355-390b312b909c"
const val valid_employee_data_response = """
{
	"employees" : [
		{
...
// Mocked empty JSON response for employee data.
const val empty_employee_data_response = """
{
    "employees" : []
}
"""

// Mocked malformed JSON response for employee data.
const val malformed_employee_data_response = """
{
	"employees" : [
		{
      "uuid" : "0d8fcc12-4d0c-425c-8355-390b312b909c",
